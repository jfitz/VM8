...
while line = gets
  ...
  if mnemonic.nil?
    if label.empty?
      # print spaces for comment (if any comment)
      print '                        #' if comment.size > 0
    else
    ...
    print format_generated_bytes(opcode, arg_size, arg_value)
    
    # print source line
    print ' '
    print format_asm_line(label, mnemonic, arg_text)
