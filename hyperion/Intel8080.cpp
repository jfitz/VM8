...
static const char* DISASSEMBLE_TABLE[] = {
    "NOP", "LXI B,word", "STAX B", "INX B", "INR B", "DCR B", "MVI B,byte", "RLC",
    "ILL", "DAD B", "LDAX B", "DCX B", "INR C", "DCR C", "MVI C,byte", "RRC",
    "ILL", "LXI D,word", "STAX D", "INX D", "INR D", "DCR D", "MVI D,byte", "RAL",
    "ILL", "DAD D", "LDAX D", "DCX D", "INR E", "DCR E", "MVI E,byte", "RAR",
    "ILL", "LXI H,word", "SHLD", "INX H", "INR H", "DCR H", "MVI H,byte", "DAA",
    "ILL", "DAD H", "LHLD", "DCX H", "INR L", "DCR L", "MVI L,byte", "CMA",
    "ILL", "LXI SP,word", "STA $", "INX SP", "INR M", "DCR M", "MVI M,byte", "STC",
    "ILL", "DAD SP", "LDA $", "DCX SP", "INR A", "DCR A", "MVI A,byte", "CMC",
    ...
    "RNZ", "POP B", "JNZ word", "JMP word", "CNZ word", "PUSH B", "ADI byte", "RST 0",
    "RZ", "RET", "JZ word", "ILL", "CZ word", "CALL word", "ACI byte", "RST 1",
    "RNC", "POP D", "JNC word", "OUT byte", "CNC word", "PUSH D", "SUI byte", "RST 2",
    "RC", "ILL", "JC word", "IN byte", "CC word", "ILL", "SBI byte", "RST 3",
    "RPO", "POP H", "JPO word", "XTHL", "CPO word", "PUSH H", "ANI byte", "RST 4",
    "RPE", "PCHL", "JPE word", "XCHG", "CPE word", "ILL", "XRI byte", "RST 5",
    "RP", "POP PSW", "JP word", "DI", "CP word", "PUSH PSW", "ORI byte", "RST 6",
    "RM", "SPHL", "JM word", "EI", "CM word", "ILL", "CPI byte", "RST 7"
};

static const unsigned int undef_ops[] =
  { 010, 020, 030, 040, 050, 060, 070, 0313, 0331, 0335, 0355, 0375 };
